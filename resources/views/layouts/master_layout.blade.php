        ...
        <div class="page">
            <div class="page-main">
                ...
                <ul class="side-menu">
                    ...
                    <li><h3>Leagues</h3></li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon ti-panel"></i><span class="side-menu__label">League</span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu">
                            <li><a href="cards.html" class="slide-item"> Add League</a></li>
                            <li><a href="calendar.html" class="slide-item"> View League</a></li>
                        </ul>
                    </li>
                </ul>
            </aside>
